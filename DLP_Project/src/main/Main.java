 ...
 *
 * Normally, it won't be needed to modify this file. Instead, modify the files
 * for each phase (which are called from here): - For Lexical Analysis, change
 * 'Lexicon.g4'. - For Syntax Analysis, change 'Grammar.g4'. - For Semantic
 * Analysis, change 'Identification.java' and 'TypeChecking.java'. - For Code
 * Generation, change 'MemoryAllocation.java' and 'MaplCodeSpecification.java'.
 */

public class Main {
    public static final String TEST_FILE = "my_input.txt"; // Used in development and testing
	...
	// IMPORTANT: When the AST has been generated, swap the following two lines of
	// code.
	parser.program();
